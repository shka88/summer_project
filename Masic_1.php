...
<body>
    ...
    <?php
        ...
        function masic_1_page()
        {
            ...
            echo "<br />";
            echo "<button id = \"btnfun1\" name=\"btnfun1\" onClick = 'location.href=\"masic_1.php?val=11\"'>존재함</button>";
        ...
        function masic_4_page($current_value){
            ...
            echo "<br />";
            echo "<button id = \"btnfun1\" name=\"btnfun1\" onClick = 'location.href=\"masic_1.php?val=4".($current_value+8),"\"'>존재함</button>";
            echo "<button id = \"btnfun2\" name=\"btnfun2\" onClick = 'location.href=\"masic_1.php?val=4".($current_value+0),"\"'>존재하지 않음</button>";
        ...
        function masic_5_page($current_value){
            ...
            echo "<br />";
            echo "<button id = \"btnfun1\" name=\"btnfun1\" onClick = 'location.href=\"masic_1.php?val=5".($current_value+16),"\"'>존재함</button>";
            echo "<button id = \"btnfun2\" name=\"btnfun2\" onClick = 'location.href=\"masic_1.php?val=5".($current_value+0),"\"'>존재하지 않음</button>";
        ...
        function masic_6_page($current_value){
            ...
            echo "<br />";
            echo "<button id = \"btnfun1\" name=\"btnfun1\" onClick = 'location.href=\"masic_1.php?val=6".($current_value+32),"\"'>존재함</button>";
            echo "<button id = \"btnfun2\" name=\"btnfun2\" onClick = 'location.href=\"masic_1.php?val=6".($current_value+0),"\"'>존재하지 않음</button>";
